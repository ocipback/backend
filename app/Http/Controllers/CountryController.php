...
use App\Http\Resources\Lookup\CountryCollection;
use App\Models\Lookup\Country;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Validator;
use App\Http\Resources\Lookup\Country as CountryResource;
...
class CountryController extends Controller
{
    ...
    if ($this->validateInputs($request)->fails()){
        return response(['errors' => $this->validateInputs($request)->errors()]);
    }
     ...
     *
     * @param  \App\Models\Lookup\Country  $country
     * @return \Illuminate\Http\Response
     */
